...
namespace WTFPrice_HTFTeam.Controllers
{
    ...
    public class UserManagementController : Controller
    {
        ...
        {
            var users = await UserManager.Users.OrderByDescending(x=>x.RegisterDate).ToListAsync();
        ...
        public async Task<ActionResult> Create(RegisterViewModel userViewModel, params string[] selectedRoles)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser
                {
                    ...
                    Avatar = "~/Upload/News/UserDefault.png"
                };
        ...
        public async Task<ActionResult> Edit([Bind(Include = "UserName,Email,Id,DOB,PhoneNumber,Avatar")] EditUserViewModel editUser, params string[] selectedRole)
        {
            if (ModelState.IsValid)
            {

...
namespace WTFPrice_HTFTeam.Controllers
{
    ...
    public class ContactManagementController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,ContactName,Email,ContactAddress,ContactPhone,UserId,FullText,Status,CreatedOn")] Feedback feedback)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,ContactName,Email,ContactAddress,ContactPhone,UserId,FullText,Status,CreatedOn")] Feedback feedback)
        {
            if (ModelState.IsValid)
            {
